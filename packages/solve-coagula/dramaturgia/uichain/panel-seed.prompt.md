# uichain — panel-seed · SOLVE ET COAGULA
...
Mostrar la **pregunta activa** de la semilla y el tema la línea de criterio de demarcación de SolveCoagula (historial Wikipedia ES) al lector
del index-reader.
