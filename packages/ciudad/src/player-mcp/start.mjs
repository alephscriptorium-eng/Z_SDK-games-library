/**
 * CLI: MCP de jugador ciudad (rabbit).
 * Actor: ZEUS_CIUDAD_PLAYER_ACTOR (default rabbit) u --actor=.
 * Puerto: ZEUS_MCP_CIUDAD (default 4133).
 */
 ...
 */
export async function startCiudadPlayerMcp(configOverride = {}) {
  const config = {
...
if (isMainModule(import.meta.url)) {
  await runMcpMain(startCiudadPlayerMcp);
}
