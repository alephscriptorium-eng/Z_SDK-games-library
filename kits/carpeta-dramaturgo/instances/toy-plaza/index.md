...
Tema: **una plaza pública y sus carteles**

Slug: `toy-plaza` · Instanciado: 2026-07-18
...
Parametriza los ejes al tema de **una plaza pública y sus carteles**. Los nombres REIC son
etiquetas del kit; el significado lo define el dramaturgo:

| Eje | Etiqueta en este juego | Qué mide aquí |
|-----|------------------------|---------------|
| **R** | Ritmo de aforo | qué mide el eje R en este juego |
| **E** | Estrategia de usos | qué mide el eje E en este juego |
| **I** | Interacción vecinal | qué mide el eje I en este juego |
| **C** | Continuidad del espacio | qué mide el eje C en este juego |

**Molde de salida:** párrafo bajo *«En una plaza pública y sus carteles, el sistema presenta…»*
