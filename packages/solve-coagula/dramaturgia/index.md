...
Tema: **la línea de criterio de demarcación de SolveCoagula (historial Wikipedia ES)**

Slug: `solve-coagula` · Instanciado: 2026-07-18
...
Parametriza los ejes al tema de **la línea de criterio de demarcación de SolveCoagula (historial Wikipedia ES)**. Los nombres REIC son
etiquetas del kit; el significado lo define el dramaturgo:

| Eje | Etiqueta en este juego | Qué mide aquí |
|-----|------------------------|---------------|
| **R** | Ritmo | qué mide el eje R en este juego |
| **E** | Estrategia | qué mide el eje E en este juego |
| **I** | Interacción | qué mide el eje I en este juego |
| **C** | Corpus | qué mide el eje C en este juego |

**Molde de salida:** párrafo bajo *«En la línea de criterio de demarcación de SolveCoagula (historial Wikipedia ES), el sistema presenta…»*
