...
Parametriza los ejes al tema de **{{THEME}}**. Los nombres REIC son
etiquetas del kit; el significado lo define el dramaturgo:

| Eje | Etiqueta en este juego | Qué mide aquí |
|-----|------------------------|---------------|
| **R** | {{REIC_R}} | {{REIC_R_HINT}} |
| **E** | {{REIC_E}} | {{REIC_E_HINT}} |
| **I** | {{REIC_I}} | {{REIC_I_HINT}} |
| **C** | {{REIC_C}} | {{REIC_C_HINT}} |

**Molde de salida:** párrafo bajo *«En {{THEME}}, el sistema presenta…»*
